...
This component is designed for Holland & Barrett's e-commerce experience, encouraging customers to purchase complementary products together. It features:
...
<Canvas of={BundlesStories.WebWorkerResponsive} />
